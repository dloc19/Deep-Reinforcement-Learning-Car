...
| `router_plan/` | A* global planner — chọn điểm đến, tính đường đi ngắn nhất, lái xe theo lộ trình (`drive_to_goal.py`); xem `router_plan/README.md` + `docs/manual_dieu_huong_astar.md` | Local, cần CARLA server sống, Python 3.7 |
